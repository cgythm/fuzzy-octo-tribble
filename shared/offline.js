(function(){
    var addClass, removeClass, online, offline, lon = [], lof = [],
        lc = [], luc = [], target_elm = null, status = null,
        cached = null;
    ...
    function init(){
        ...
        console.debug("init() executing with " + ion(navigator.onLine));
        update(status);
    }
    ...
    function update(isOnline, fromCache){
        ...
        if(fromCache !== null && typeof fromCache == "boolean" & target_elm !== null){
            if(fromCache){
